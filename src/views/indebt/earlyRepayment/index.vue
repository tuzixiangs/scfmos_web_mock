...
const rows = ref<RepaymentRow[]>([
  { id: 1, applicationNo: 'ERA202608270001', loanNo: 'DK202607010008', customerName: '阿姆特拉斯供应链有限公司', coreCustomerNo: 'C2025040300000003', coreEnterpriseName: '宁波钢铁贸易有限公司', businessType: '货押融资', currency: '人民币', repaymentAmountText: '1,200,000.00', principalText: '1,180,000.00', interestText: '20,000.00', repaymentDate: '2026-08-29', applicationDate: '2026-08-27', applicationChannel: '企业网银', currentStage: '客户经理确认', phase: 'pending', status: '待处理' },
  { id: 2, applicationNo: 'ERA202608260002', loanNo: 'DK202606150012', customerName: '华东金属贸易有限公司', coreCustomerNo: 'C2025050600000012', coreEnterpriseName: '华东钢铁集团有限公司', businessType: '先票/款后货', currency: '人民币', repaymentAmountText: '860,000.00', principalText: '850,000.00', interestText: '10,000.00', repaymentDate: '2026-08-28', applicationDate: '2026-08-26', applicationChannel: '企业网银', currentStage: '经营单位负责人', phase: 'reviewing', status: '审查审批中' },
  { id: 3, applicationNo: 'ERA202608200003', loanNo: 'DK202605200006', customerName: '丰禾农业发展有限公司', coreCustomerNo: 'C2025042800000021', coreEnterpriseName: '丰禾农业集团有限公司', businessType: '货押融资', currency: '人民币', repaymentAmountText: '700,000.00', principalText: '690,000.00', interestText: '10,000.00', repaymentDate: '2026-08-22', applicationDate: '2026-08-20', applicationChannel: '企业网银', currentStage: '审批完成', phase: 'approved', status: '审批通过' }
])
...
const detailFields = computed(() => { const row = current.value; return row ? [{ label: '借据号', value: row.loanNo }, { label: '客户名称', value: row.customerName }, { label: '核心企业名称', value: row.coreEnterpriseName }, { label: '业务品种', value: row.businessType }, { label: '还款金额', value: `${row.repaymentAmountText} ${row.currency}` }, { label: '归还本金', value: row.principalText }, { label: '归还利息', value: row.interestText }, { label: '还款日期', value: row.repaymentDate }, { label: '申请日期', value: row.applicationDate }, { label: '申请渠道', value: row.applicationChannel }, { label: '当前阶段', value: row.currentStage }] : [] })
...
const submit = () => { if (!selected.value) return ElMessage.warning('请先选择一条申请'); selected.value.phase = 'reviewing'; selected.value.status = '审查审批中'; selected.value.currentStage = '经营单位负责人'; ElMessage.success('已提交至经营单位负责人') }
