...
const columns = [
  ...
  { label: '发生类型', field: 'occurtypename', minWidth: 100  },
  { label: '币种', field: 'currency', minWidth: 100  },
  { label: '批复金额', field: 'businesssum', minWidth: 100  },
  { label: '主要担保方式', field: 'vouchtypename', minWidth: 100  },
  { label: '登记人', field: 'inputusername', minWidth: 100  },
  { label: '登记机构', field: 'inputorgname', minWidth: 100 },
  { label: '完成时间', field: 'endtime', minWidth: 160 }
]
...
const goDetail = () => {
  ...
  router.push({
    ...
    query: {
      ...
      t: Date.now(),
      _tagTitle: '链属批复详情', // 对tag页签中的title，重命名
    }
  })
}
